        ...
        <section className="hidden md:block container mx-auto px-12 lg:px-16 pb-32">
          ...
          <div className="mb-32">
            ...
            <div className="flex items-start justify-between">
              ...
              <Link href="/projekty/mados" className="flex items-center gap-2 text-black hover:opacity-70 transition-opacity">
          ...
          <div>
            <div className="w-full aspect-[21/9] rounded-2xl overflow-hidden mb-8">
              <video 
                ...
                className="w-full h-full object-cover"
              >
                <source src={"/videos/kkvideo.webm"} type="video/webm" />
                <source src={"/videos/kkvideo.mp4"} type="video/mp4" />
              </video>
            </div>
            <div className="flex items-start justify-between">
              <div>
