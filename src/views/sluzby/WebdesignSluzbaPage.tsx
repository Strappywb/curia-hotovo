        ...
        <section className="px-6 md:px-12 lg:px-16 pb-32 md:pb-40">
          <div className="max-w-[1100px] mx-auto">
            ...
            >
              Značka, UX,
              <br />
              <span className="bg-gradient-to-r from-blue-950 via-blue-600 to-blue-400 bg-clip-text text-transparent">
                zkušenost
              </span>
            </motion.h2>
            ...
            >
              <a
                href="/kontakt"
                className="inline-flex items-center gap-3 px-8 py-4 rounded-full text-white font-semibold text-[15px] transition-all duration-300 hover:scale-[1.03] hover:shadow-xl"
                style={{
                  background:
