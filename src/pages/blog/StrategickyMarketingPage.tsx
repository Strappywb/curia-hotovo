      ...
      <main className="overflow-x-hidden">
        ...
        <section className="w-full bg-white py-20 md:py-32">
          <div className="max-w-4xl mx-auto px-8 md:px-12 lg:px-16">
            ...
            <div className="mb-8">
              <span className="font-mono text-sm text-black/60">Marketing</span>
              <span className="mx-4 text-black/30">•</span>
              <span className="font-mono text-sm text-black/60">10. 1. 2024</span>
            </div>
        ...
        <section className="w-full bg-[#CCFF00] py-20 md:py-32">
          <div className="max-w-4xl mx-auto px-8 md:px-12 lg:px-16 text-center">
            <h2 className="font-satoshi text-3xl md:text-4xl font-bold text-black mb-6">
            ...
            <Link 
              to="/#contact" 
              className="inline-block bg-black text-white font-satoshi font-bold px-8 py-4 hover:bg-gray-900 transition-colors"
            >
              Kontaktovat
            </Link>
          </div>
