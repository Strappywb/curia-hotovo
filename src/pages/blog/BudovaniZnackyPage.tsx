...
const BudovaniZnackyPage = () => {
  return (
    <>
      <Helmet>
        <title>Budování značky od základů | CURIA Blog</title>
        <meta name="description" content="Silná značka je víc než logo. Je to příběh, hodnoty a emoce, které vytváříte u svých zákazníků." />
        <meta property="og:title" content="Budování značky od základů | CURIA Blog" />
        <meta property="og:description" content="Silná značka je víc než logo. Je to příběh, hodnoty a emoce, které vytváříte u svých zákazníků." />
        <link rel="canonical" href="https://curia.cz/blog/budovani-znacky" />
      ...
      <main className="overflow-x-hidden">
        ...
        <section className="w-full bg-white py-20 md:py-32">
          <div className="max-w-4xl mx-auto px-8 md:px-12 lg:px-16">
            ...
            <div className="mb-8">
              <span className="font-body font-semibold text-sm text-black/60">Branding</span>
              <span className="mx-4 text-black/30">•</span>
              <span className="font-body font-semibold text-sm text-black/60">5. 1. 2024</span>
            </div>
