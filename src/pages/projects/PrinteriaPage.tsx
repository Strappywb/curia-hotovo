...
const PrinteriaPage = () => {
  return (
    <>
      <Helmet>
        <title>Printeria - Case study | CURIA Portfolio</title>
        <meta name="description" content="Case study spolupráce s Printeria. Tiskové služby Praha. Marketingová strategie a akvizice klientů." />
        <meta property="og:title" content="Printeria - Case study | CURIA Portfolio" />
        <meta property="og:description" content="Case study spolupráce s Printeria. Tiskové služby Praha. Marketingová strategie a akvizice klientů." />
          ...
          <div className="max-w-5xl mx-auto px-8 md:px-12 lg:px-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div>
                ...
                <p className="font-body font-semibold text-sm text-black/60">Kompletní redesign</p>
              </div>
              <div>
                <h3 className="font-heading text-lg text-black mb-2">Branding</h3>
                <p className="font-body font-semibold text-sm text-black/60">Nová vizuální identita</p>
              </div>
              <div>
                <h3 className="font-heading text-lg text-black mb-2">Marketing</h3>
                <p className="font-body font-semibold text-sm text-black/60">Meta Ads, kreativa</p>
              </div>
              <div>
                <h3 className="font-heading text-lg text-black mb-2">Technologie</h3>
                <p className="font-body font-semibold text-sm text-black/60">AI outreach systém</p>
              </div>
            </div>
          </div>
        </section>
