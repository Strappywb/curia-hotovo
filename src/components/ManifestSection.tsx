const ManifestSection = () => {
  return (
    <section className="w-full bg-background px-4 md:px-6 pb-4 md:pb-3">
      <div className="bg-white rounded-3xl md:rounded-[2.5rem] ring-4 ring-white px-6 md:px-12 lg:px-16 py-16 md:py-24 lg:py-32 flex items-center justify-center">
