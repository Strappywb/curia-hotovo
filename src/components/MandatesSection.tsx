...
const mandates = [
  { id: 1, image: verdiktMados.src, alt: "Mados projekt" },
  { id: 2, image: verdiktHf.src, alt: "HF projekt" },
  { id: 3, image: verdiktPrint.src, alt: "Print projekt" },
  { id: 4, image: verdiktSturm.src, alt: "Šturm projekt" },
];
